        ...
        <div className="grid md:grid-cols-2 gap-20 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="glass-card p-6 border-l-4 border-l-error">
              ...
              <div className="h-24 w-full bg-surface-container-lowest rounded-sm overflow-hidden flex items-end px-4 gap-1">
                <div className="w-full h-1/4 bg-error/20 rounded-t-sm"></div>
                <div className="w-full h-1/3 bg-error/20 rounded-t-sm"></div>
                <div className="w-full h-2/3 bg-error/40 rounded-t-sm"></div>
                <div className="w-full h-5/6 bg-error/80 rounded-t-sm"></div>
                <div className="w-full h-full bg-error rounded-t-sm relative">
                  <div className="absolute -top-6 left-1/2 -translate-x-1/2 text-[10px] font-bold text-error">PEAK</div>
                </div>
                <div className="w-full h-3/4 bg-error/60 rounded-t-sm"></div>
                <div className="w-full h-1/2 bg-error/30 rounded-t-sm"></div>
              </div>
            ...
            <div className="glass-card p-6 border-l-4 border-l-primary">
              ...
              <div className="h-24 w-full bg-surface-container-lowest rounded-sm overflow-hidden flex items-end px-4 gap-1">
                <div className="w-full h-full bg-primary rounded-t-sm relative">
                  <div className="absolute -top-6 left-1/2 -translate-x-1/2 text-[10px] font-bold text-primary">OPTIMAL</div>
                </div>
                <div className="w-full h-5/6 bg-primary/80 rounded-t-sm"></div>
                <div className="w-full h-2/3 bg-primary/40 rounded-t-sm"></div>
                <div className="w-full h-1/3 bg-primary/20 rounded-t-sm"></div>
                <div className="w-full h-1/6 bg-primary/10 rounded-t-sm"></div>
                <div className="w-full h-1/6 bg-primary/10 rounded-t-sm"></div>
                <div className="w-full h-1/6 bg-primary/10 rounded-t-sm"></div>
              </div>
              <div className="mt-4 flex gap-2">
